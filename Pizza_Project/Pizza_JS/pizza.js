...
function getTopping(runningTotal, text1) {
    ...
    for (var j = 0; j < toppingArray.length; j++) {
        if (toppingArray[j].checked) {
            ...
            console.log("selected topping items: ("+ toppingArray[j].value +")");
    ...
    console.log(toppingCount + " topping - 1 free topping = " + "£"
        + toppingTotal + ".00");
...
function getVeggies(runningTotal, text1) {
    ...
    for (var k = 0; k < veggieArray.length; k++) {
        if (veggieArray[k].checked) {
            ...
            console.log("selected vegetable items: (" + veggieArray[k].value + ")");
    ...
    if (veggieCount > 1) {
        veggieTotal = (veggieCount - 1); // first veggie is free
    } else {
        veggieTotal = 0;
    }
    ...
    console.log(veggieCount + " vegetable - 1 free vegetable = " + "£" + veggieTotal + ".00");
    console.log("Purchase Total: " + "£" + runningTotal + ".00");
