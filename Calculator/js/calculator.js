...
const Calculator = {
    ...
    First_Operand: null,
    //This checks wether or not the second operand has beed inputted by the user
...
function Input_Digit(digit) {
    ...
    //This checks if the Wait_Secomd_Operand is true and sets Display_Value
...
function Handle_Operator(Next_Operator) {
    ...
    //Calculator.First_Operant if it does not already exist
...
keys.addEventListener('click', (event) => {
    //The target variable in an object that represents the element
    //that was clicked
    const { target } = event;
